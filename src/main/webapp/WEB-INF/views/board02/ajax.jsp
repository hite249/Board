	...
	<script type="text/javascript">
		...
		function loadPage(page) {
			...
			$.ajax({
	        	...
	        	type:"POST",
	        	url:"/board02/data/boardList.do",      
	        	data:""+page,      
	        	success:function(result){
	        		var htmlString = "";
	        		for( var i=0;i<result.boardList.length;i++ ) {
	        			htmlString += "<tr>";
	        			htmlString += "<td>" + result.boardList[i].no + "</td>";
	        			htmlString += "<td>" + result.boardList[i].subject + "</td>";
	        			htmlString += "</tr>";
	        		}
	        		$("#boardTable tbody").html(htmlString);
	        		$("#board02TotalCount").html( "글 갯수 : " + result.totalCount );
